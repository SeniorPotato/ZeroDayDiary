...
description: "DragonForce ransomware used a custom malware named 'Backdoor.Turn' to hide command-and-control traffic inside Microsoft Teams relay infrastructure."
pubDate: 2026-06-16
draft: false
tags:
  - security
  - threat-intelligence
canonical: "https://zerodaydiary.com/blog/2026/06/ransomware-gang-abuses-microsoft-teams-relays-to-hide-malicious-traffic/"
---

## What happened
Recent reporting highlighted ransomware gang abuses microsoft teams relays to hide malicious traffic. DragonForce ransomware used a custom malware named 'Backdoor.Turn' to hide command-and-control traffic inside Microsoft Teams relay infrastructure. The backdoor abuses the Traversal Using Relays around NAT (TURN) protocol used by Microsoft Teams to distribute messages when a direct connection to the client is unavailable (e.g., clients on a private network).
...
## Further reading
- [Primary source](https://www.bleepingcomputer.com/news/security/ransomware-gang-abuses-microsoft-teams-relays-to-hide-malicious-traffic/)
